...
g+geom_point(colour="blue",shape=20,size=8)+labs(title="Number of games vs number of scored sixes")+labs(x="Log 10 of number of games")+labs(y="Number of scored sixes")+scale_y_continuous(breaks=y)+scale_x_continuous(breaks=df$z)
